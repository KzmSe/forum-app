...
public class TopicDaoImpl implements TopicDao {
    ...
    private final String GET_TOPIC_BY_ID_SQL = "select t.id_topic, t.title, t.description as t_description, t.share_date, t.view_count, t.status, u.id_user as t_id_user, u.first_name as t_first_name, u.image as t_image, u.last_name as t_last_name  from topic t inner join user u on t.id_user=u.id_user where t.id_topic=?";
    ...
    public Topic getTopicById(int id)  {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                user.setImagePath(rs.getString("t_image"));
                topic.setUser(user);
