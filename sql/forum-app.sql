...
INSERT INTO `topic` VALUES (1,'10 Kids Unaware of Their Halloween Costume','Today, we re looking at three particularly interesting stories. Pinterest added a new location-based feature on Wednesday that uses Place Pins as a way to map out vacations and favorite areas. Southwest Airlines is providing Wi-Fi access from gate to gate for $8 per day through an onboard hotspot. And in an effort to ramp up its user base, Google Wallet is offering a debit card that can take out cash from.','2018-10-21 03:00:00',304,1),(2,'josso integration with spring web srevices','I require help on integration of web service with JOSSO for authentication. Whenever a request comes from SOAP UI(client) to service, it should be authenticated against an Active Directory server, and if it succeeds then it should hit the service endpoint.','2018-10-20 08:15:00',333,3),(3,'Unusual Sign In notification with Spring Security','Some popular websites send email/push notifications to their users if they notice unusual or suspicious login activity. Examples include Google, Facebook, Mozilla, Booking.com. How to implement this feature in Java/Spring application?','2018-09-15 05:30:00',193,4),(12,'How to fix Maven, Maven Configuration and Maven Dependency Problems in Eclipse','I went to directory of my project MainDirectory/MyProject and I run the same command, once again it worked well.I run Eclipse and I wanted to import \"Existing Maven Projects\". I chose MainDirectory as RootDirectory and I got a warning.','2018-11-09 14:01:04',0,3);
...
INSERT INTO `user` VALUES (1,'elvin@gmail.com','1234','123456',1,2,'Elvin','Xalafov'),(3,'senan@gmail.com','1234','123456',1,2,'Senan','Kazimov'),(4,'fatime@gmail.com','1234','123456',1,2,'Fatime','Gurbanova'),(5,'vuqar@gmail.com','1234','123456',1,2,'Vuqar','Nesirov'),(16,'senan0144@gmail.com','WM2wmqp/RW55f/Ljs7IYmg==','2d39e56e-d4fc-471c-a648-8cc2eab8678b',2,2,'senan','kazimov');
...
-- Dump completed on 2018-11-09 21:28:20
